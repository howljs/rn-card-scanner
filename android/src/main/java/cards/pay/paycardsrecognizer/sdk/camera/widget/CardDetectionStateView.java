...
public class CardDetectionStateView extends View {
    ...
    public synchronized void setDrawableColor(int color) {
      if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.Q) {
        mCornerTopLeftDrawable.setColorFilter(new BlendModeColorFilter(color, BlendMode.SRC_IN));
        mCornerTopRightDrawable.setColorFilter(new BlendModeColorFilter(color, BlendMode.SRC_IN));
        mCornerBottomLeftDrawable.setColorFilter(new BlendModeColorFilter(color, BlendMode.SRC_IN));
        mCornerBottomRightDrawable.setColorFilter(new BlendModeColorFilter(color, BlendMode.SRC_IN));
        mLineTopDrawable.setColorFilter(new BlendModeColorFilter(color, BlendMode.SRC_IN));
        mLineLeftDrawable.setColorFilter(new BlendModeColorFilter(color, BlendMode.SRC_IN));
        mLineRightDrawable.setColorFilter(new BlendModeColorFilter(color, BlendMode.SRC_IN));
        mLineBottomDrawable.setColorFilter(new BlendModeColorFilter(color, BlendMode.SRC_IN));
      } else {
        mCornerTopLeftDrawable.setColorFilter(color, PorterDuff.Mode.SRC_IN);
        mCornerTopRightDrawable.setColorFilter(color, PorterDuff.Mode.SRC_IN);
        mCornerBottomLeftDrawable.setColorFilter(color, PorterDuff.Mode.SRC_IN);
        mCornerBottomRightDrawable.setColorFilter(color, PorterDuff.Mode.SRC_IN);
        mLineTopDrawable.setColorFilter(color, PorterDuff.Mode.SRC_IN);
        mLineLeftDrawable.setColorFilter(color, PorterDuff.Mode.SRC_IN);
        mLineRightDrawable.setColorFilter(color, PorterDuff.Mode.SRC_IN);
        mLineBottomDrawable.setColorFilter(color, PorterDuff.Mode.SRC_IN);
      }
    }

  public synchronized void resetDrawableColor() {
    mCornerTopLeftDrawable.clearColorFilter();
    mCornerTopRightDrawable.clearColorFilter();
    mCornerBottomLeftDrawable.clearColorFilter();
    mCornerBottomRightDrawable.clearColorFilter();
    mLineTopDrawable.clearColorFilter();
    mLineLeftDrawable.clearColorFilter();
    mLineRightDrawable.clearColorFilter();
    mLineBottomDrawable.clearColorFilter();
  }
